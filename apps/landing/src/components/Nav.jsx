...
export default function Nav() {
  ...
  return (
    <nav className={`nav${isScrolled ? ' nav-scrolled' : ''}`}>
      {/* Scroll progress bar */}
      <div className="scroll-indicator" style={{ '--scroll-progress': scrollProgress }} />
      <div className="nav-in">
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          >
            {theme === 'light' ? (
              <svg viewBox="0 0 24 24" fill="none" className="icon-moon" stroke="currentColor" strokeWidth="2">
                <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
              </svg>
            ) : (
              <svg viewBox="0 0 24 24" fill="none" className="icon-sun" stroke="currentColor" strokeWidth="2">
